        ...
        <InfoLayout title="Protocol Terms">
            <div className="space-y-16 md:space-y-32">
                <section className="space-y-8 py-8 md:py-12 faded-line-b">
                    <h2 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.5em] text-[#10b981]">01. Acceptance of Protocol</h2>
                ...
                <section className="space-y-8 py-8 md:py-12 faded-line-b">
                    <h2 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.5em] text-[#10b981]">02. Service Specification</h2>
                    <p className="text-xl md:text-2xl text-white/50 leading-tight font-black uppercase tracking-tighter">
                ...
                <section className="space-y-8 py-8 md:py-12 border-l-4 border-[#f59e0b] pl-8 md:pl-16">
                    <h2 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.5em] text-[#f59e0b]">03. Adjustment Protocol</h2>
                    <p className="text-xl md:text-2xl text-white/50 leading-tight font-black uppercase tracking-tighter">
                ...
                <section className="space-y-8 py-8 md:py-12 faded-line-b">
                    <h2 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.5em] text-[#10b981]">04. Settlement Terms</h2>
                    <p className="text-xl md:text-2xl text-white/50 leading-tight font-black uppercase tracking-tighter">
                ...
                <section className="space-y-8 py-8 md:py-12 faded-line-b">
                    <h2 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.5em] text-[#10b981]">05. Entity Responsibility</h2>
                    <p className="text-xl md:text-2xl text-white/50 leading-tight font-black uppercase tracking-tighter">
