    ...
    return (
        <InfoLayout title={`Service Infrastructure`}>
            <div className="space-y-16 md:space-y-32">
                <p className="text-2xl md:text-4xl lg:text-6xl text-white/40 font-black leading-tight max-w-5xl tracking-tighter uppercase">
                ...
                <div className="grid md:grid-cols-3 gap-12 md:gap-16 py-12 md:py-20 faded-line-y">
                    <div className="space-y-6 md:space-y-8">
                        <div className="w-12 h-1 bg-[#10b981]"></div>
                        <h3 className="text-xl md:text-2xl font-black text-white uppercase tracking-tighter">Secure Ledger</h3>
                        <p className="text-white/40 text-base md:text-lg font-medium leading-relaxed uppercase tracking-tight">
                            Every transaction is recorded on an encrypted, immutable ledger ensuring complete auditability and financial transparency.
                        </p>
                    </div>
                    <div className="space-y-6 md:space-y-8 md:faded-line-l md:pl-12 lg:pl-16">
                        <div className="w-12 h-1 bg-[#10b981]"></div>
                        <h3 className="text-xl md:text-2xl font-black text-white uppercase tracking-tighter">Global Settlement</h3>
                        <p className="text-white/40 text-base md:text-lg font-medium leading-relaxed uppercase tracking-tight">
                    ...
                    <div className="space-y-6 md:space-y-8 md:faded-line-l md:pl-12 lg:pl-16">
                        <div className="w-12 h-1 bg-[#10b981]"></div>
                        <h3 className="text-xl md:text-2xl font-black text-white uppercase tracking-tighter">Verified Entities</h3>
                        <p className="text-white/40 text-base md:text-lg font-medium leading-relaxed uppercase tracking-tight">
                ...
                <div className="grid md:grid-cols-2 gap-12 md:gap-16 py-12 md:py-20">
                    <div className="space-y-6 md:space-y-8">
                        <h2 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.5em] text-[#f59e0b]">Compliance Framework</h2>
                    ...
                    <div className="space-y-6 md:space-y-8 md:faded-line-l md:pl-12 lg:pl-16">
                        <h2 className="text-[10px] md:text-[11px] font-black uppercase tracking-[0.5em] text-[#f59e0b]">Operational Integrity</h2>
                        <p className="text-xl md:text-2xl text-white/50 leading-tight font-black uppercase tracking-tighter">
