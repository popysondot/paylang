    ...
    return (
        <div className="min-h-screen bg-black text-white selection:bg-[#10b981]/30 overflow-x-hidden flex flex-col">
            ...
            <div className="fixed top-0 left-0 w-full h-full pointer-events-none overflow-hidden z-0">
                <div className="absolute -top-[20%] -left-[10%] w-[70%] h-[70%] bg-[#10b981]/5 blur-[120px]"></div>
                <div className="absolute -bottom-[20%] -right-[10%] w-[60%] h-[60%] bg-[#f59e0b]/5 blur-[120px]"></div>
            </div>
            ...
            <nav className="w-full max-w-[1400px] mx-auto px-4 md:px-8 py-6 md:py-10 flex flex-col sm:flex-row justify-between items-center gap-6 relative z-10 faded-line-b">
                ...
                <Link to="/" className="modern-action-white opacity-40 hover:opacity-100 group text-[10px]">
                    <ArrowLeft size={14} className="group-hover:-translate-x-1 transition-transform" /> REVERT TO HUB
                </Link>
            </nav>

            <main className="relative z-10 flex-1 w-full max-w-[1400px] mx-auto px-4 md:px-8 py-12 md:py-20 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <div className="max-w-5xl">
                    <div className="mb-12 md:mb-24 space-y-6">
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-7xl font-black tracking-tighter leading-tight text-white uppercase">
                            {title}
                        </h1>
                    </div>

                    <div className="prose prose-invert max-w-none 
                        prose-h2:text-2xl md:prose-h2:text-3xl prose-h2:font-black prose-h2:tracking-tighter prose-h2:text-white prose-h2:uppercase prose-h2:mt-16 md:prose-h2:mt-24 prose-h2:mb-8 md:prose-h2:mb-10
                        prose-p:text-white/40 prose-p:leading-relaxed prose-p:text-base md:prose-p:text-lg prose-p:font-medium
                        prose-strong:text-white/80 prose-strong:font-black
                        prose-ul:list-none prose-ul:pl-0
                        prose-li:border-l prose-li:faded-line prose-li:pl-6 md:prose-li:pl-10 prose-li:py-4 prose-li:mb-4">
                        {children}
                    </div>
                </div>
            </main>
            ...
            {/* Footer */}
            <footer className="w-full max-w-[1400px] mx-auto px-4 md:px-8 py-10 md:py-16 flex flex-col md:flex-row justify-between items-center md:items-end gap-12 faded-line-t mt-auto relative z-10">
                <div className="flex flex-wrap justify-center md:justify-start gap-x-8 gap-y-4 text-[10px] md:text-[11px] font-black uppercase tracking-[0.3em] text-white/30">
